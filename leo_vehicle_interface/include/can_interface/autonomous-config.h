...
// DBC filename      : AUTONOMOUS_PC.dbc
#pragma once
...
/* ------------------------------------------------------------------------- *
 ...
 #define AUTONOMOUS_USE_BITS_SIGNAL
...
/* #define AUTONOMOUS_USE_CANSTRUCT */
...
#define AUTONOMOUS_USE_SIGFLOAT 
...
/* #define AUTONOMOUS_USE_DIAG_MONITORS */


/* ------------------------------------------------------------------------- *
  When monitor using is enabled (AUTONOMOUS_USE_DIAG_MONITORS) and define below
...
/* #define AUTONOMOUS_USE_MONO_FMON */
