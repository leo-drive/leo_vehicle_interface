...
/* #define FLUX_USE_DIAG_MONITORS */


/* ------------------------------------------------------------------------- *
  When monitor using is enabled (FLUX_USE_DIAG_MONITORS) and define below
