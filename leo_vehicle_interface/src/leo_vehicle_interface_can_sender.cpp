...
LeoVehicleInterfaceCanSender::LeoVehicleInterfaceCanSender(
    const rclcpp::NodeOptions &options)
    : Node{"leo_vehicle_interface_can_sender", options} {
  // params
  ...
  front_wheel_cmd_pub_ =
      create_publisher<leo_vehicle_interface_msgs::msg::FrontWheelCommand>(
          "/leo_vehicle_interface/front_wheel_cmd", rclcpp::QoS(1));
  longitudinal_cmd_pub_ =
      create_publisher<leo_vehicle_interface_msgs::msg::LongitudinalCommand>(
          "/leo_vehicle_interface/longitudinal_cmd", rclcpp::QoS(1));
  vehicle_cmd_pub_ =
      create_publisher<leo_vehicle_interface_msgs::msg::VehicleCommand>(
  ...
  vehicle_emergency_cmd_sub_ =
      create_subscription<tier4_vehicle_msgs::msg::VehicleEmergencyStamped>(
          ...
          std::bind(
              &LeoVehicleInterfaceCanSender::vehicle_emergency_cmd_callback,
              this, std::placeholders::_1));
  ...
  data_publish_can_timer_ = create_timer(
      ...
      std::bind(&LeoVehicleInterfaceCanSender::data_publish_timer_callback,
                this));
}
...
RCLCPP_COMPONENTS_REGISTER_NODE(
    leo_vehicle_interface::LeoVehicleInterfaceCanSender)